...
struct Page13_YourMagicLight: View {
                ...
                VStack{
                    HStack{
                        Button("〈 ", action: {previousIsClicked = true})
                            ...
                            .shadow(radius: 10)
                        Image("YourMagicLight_25")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
                            .padding(.leading, 80)
                        Image("YourMagicLight_26")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
...
//                                    .fontWeight(.bold)
                    ...
                    if previousIsClicked{
                        Page12_YourMagicLight()
                    }
                    if nextIsClicked{
                        Page14_YourMagicLight()
                    }
...
struct Page13_YourMagicLight_Previews: PreviewProvider {
    static var previews: some View {
        Page13_YourMagicLight()
    }
}
