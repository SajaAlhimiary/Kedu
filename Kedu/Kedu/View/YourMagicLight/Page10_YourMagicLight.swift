...
struct Page10_YourMagicLight: View {
                ...
                VStack{
                    HStack{
                        Button("〈 ", action: {previousIsClicked = true})
                            ...
                            .shadow(radius: 10)
                        Image("YourMagicLight_19")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
                            .padding(.leading, 80)
                        Image("YourMagicLight_20")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
...
struct Page10_YourMagicLight_Previews: PreviewProvider {
