...
struct Page11_YourMagicLight: View {
                ...
                VStack{
                    HStack{
                        Button("〈 ", action: {previousIsClicked = true})
                            ...
                            .shadow(radius: 10)
                        Image("YourMagicLight_21")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
                            .padding(.leading, 80)
                        Image("YourMagicLight_22")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
...
struct Page11_YourMagicLight_Previews: PreviewProvider {
