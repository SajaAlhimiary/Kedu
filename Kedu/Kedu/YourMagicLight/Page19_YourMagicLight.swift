...
struct Page19_YourMagicLight: View {
                ...
                VStack{
                    HStack{
                        Button("〈 ", action: {previousIsClicked = true})
                            ...
                            .shadow(radius: 10)
                        Image("YourMagicLight_37")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
                            .padding(.leading, 80)
                        Image("YourMagicLight_38")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
...
//                                    .fontWeight(.bold)
                    ...
                    if previousIsClicked{
                        Page18_YourMagicLight()
                    }
                    if nextIsClicked{
                        Page20_YourMagicLight()
                    }
...
struct Page19_YourMagicLight_Previews: PreviewProvider {
