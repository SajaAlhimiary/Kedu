...
struct Page5_YourMagicLight: View {
                ...
                VStack{
                    HStack{
                        Button("〈 ", action: {previousIsClicked = true})
                            ...
                            .shadow(radius: 10)
                        Image("YourMagicLight_9")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
                            .padding(.leading, 80)
                        Image("YourMagicLight_10")
                            .resizable()
                            .frame(width: 500, height: 600)
                            .clipShape(RoundedRectangle(cornerRadius: 20))
                            .shadow(radius: 20)
...
struct Page5_YourMagicLight_Previews: PreviewProvider {
    static var previews: some View {
        Page5_YourMagicLight()
    }
}
